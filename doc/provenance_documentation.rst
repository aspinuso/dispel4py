...
encoding defaults to sys.getdefaultencoding().
errors defaults to 'strict'.
(base) orfeus-as:dispel4py aspinuso2$ pydocmd simple dispel4py.provenance++ > provenance_documentation.md
Building index...
Started generating documentation...
(base) orfeus-as:dispel4py aspinuso2$ m2r provenance_documentation.md
provenance_documentation.rst already exists. overwrite it? [y/n]: y
(base) orfeus-as:dispel4py aspinuso2$ cat provenance_documentation.rst 
